<div class="container-fluid sb1">
    <div class="row">
        ...
        <div class="col-md-2 col-sm-3 col-xs-6 sb1-1">
            ...
            <a href="index.php" class="logo"><img src="images/furnishing.png" alt="">
            </a>
        </div>
        <!--== SEARCH ==-->
        <div class="col-md-6 col-sm-6 mob-hide">
            ...
            <ul class="navlist1">
                ...
                <ul id='top-menu1' class='dropdown-content top-menu-sty'>
                    ...
                    <li class="divider"></li>
                    <li><a href="listing-add.php" class="ho-dr-con-last waves-effect"></i>ADD NEW LISTING</a>
                    </li>
                    <li><a href="listing-cat-all.php" class="ho-dr-con-last waves-effect"></i>ALL LISTING CATEGORIES</a>
                    </li>
                </ul>
